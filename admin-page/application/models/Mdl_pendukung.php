...
class Mdl_pendukung extends CI_Model {
	...
	var $table = 'fasilitas_pendukung';
	var $column_order = array('faspen_id', 'faspen_nama', 'faspen_icon',null); //set column field database for datatable orderable
	var $column_search = array('faspen_id', 'faspen_nama', 'faspen_icon'); //set column field database for datatable searchable just title , author , category are searchable
	var $order = array('faspen_id' => 'asc'); // default order

	var $column_order_en = array('faspen_id', 'faspen_nama', 'faspen_icon',null); //set column field database for datatable orderable
	var $column_search_en = array('faspen_id', 'faspen_nama', 'faspen_icon'); //set column field database for datatable searchable just title , author , category are searchable
	var $order_en = array('faspen_id' => 'asc'); // default order
