...
class Mdl_produsen extends CI_Model {
	...
	var $table = 'produsen';
	var $column_order = array('id_produsen','nama_produsen','produsen_deskripsi','tgl_bergabung', 'alamat_produsen'); //set column field database for datatable orderable
	var $column_search = array('id_produsen','nama_produsen','produsen_deskripsi','tgl_bergabung', 'alamat_produsen'); //set column field database for datatable searchable just title , penulis , category are searchable
	var $order = array('id_produsen' => 'asc'); // default order
