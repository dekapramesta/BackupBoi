...
class Mdl_berwahana extends CI_Model {
	...
	var $table2 = 'wahana_wisata';
	var $column_orderid = array('a.wahwis_id','a.wisata_id','a.wahana_id','a.wahwis_htm','b.wahana_nama','c.wisata_id',null); //set column field database for datatable orderable
	var $column_searchid = array('a.wahwis_id','a.wisata_id','a.wahana_id','a.wahwis_htm','b.wahana_nama','c.wisata_id');
	var $orderid = array('a.wahwis_id' => 'asc');
	
	var $column_orderid_en = array('a.wahwis_id','a.wisata_id','a.wahana_id','a.wahwis_htm','b.wahana_nama','c.wisata_id',null); //set column field database for datatable orderable
	var $column_searchid_en = array('a.wahwis_id','a.wisata_id','a.wahana_id','a.wahwis_htm','b.wahana_nama','c.wisata_id');
	var $orderid_en = array('a.wahwis_id' => 'asc');
	...
	private function _get_datatables_queryid() {
		...
		$this->db->from('wahana_wisata a');
		$this->db->join('wahana b','b.wahana_id=a.wahana_id','left outer');
	...
	private function _get_datatables_queryid_en() {
		...
		$this->db2->from('wahana_wisata a');
		$this->db2->join('wahana b','b.wahana_id=a.wahana_id','left outer');
