...
class Mdl_penulis extends CI_Model {
	...
	var $table = 'penulis';
	var $column_order = array('penulis_id','penulis_nama','penulis_profesi','penulis_tahun_bergabung', 'penulis_deskripsi'); //set column field database for datatable orderable
	var $column_search = array('penulis_id','penulis_nama','penulis_profesi','penulis_tahun_bergabung', 'penulis_deskripsi'); //set column field database for datatable searchable just title , penulis , category are searchable
	var $order = array('penulis_id' => 'asc'); // default order

	var $column_order_en = array('penulis_id','penulis_nama','penulis_profesi','penulis_tahun_bergabung', 'penulis_deskripsi'); //set column field database for datatable orderable
	var $column_search_en = array('penulis_id','penulis_nama','penulis_profesi','penulis_tahun_bergabung', 'penulis_deskripsi'); //set column field database for datatable searchable just title , penulis , category are searchable
	var $order_en = array('penulis_id' => 'asc'); // default order
