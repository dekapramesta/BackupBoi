...
class Mdl_wahana extends CI_Model {
	...
	var $table = 'wahana';
	var $column_order = array('wahana_id', 'wahana_nama', 'wahana_icon','wahana_deskripsi',null); //set column field database for datatable orderable
	var $column_search = array('wahana_id', 'wahana_nama', 'wahana_icon','wahana_deskripsi'); //set column field database for datatable searchable just title , author , category are searchable
	var $order = array('wahana_id' => 'asc'); // default order

	var $column_order_en = array('wahana_id', 'wahana_nama', 'wahana_icon','wahana_deskripsi',null); //set column field database for datatable orderable
	var $column_search_en = array('wahana_id', 'wahana_nama', 'wahana_icon','wahana_deskripsi'); //set column field database for datatable searchable just title , author , category are searchable
	var $order_en = array('wahana_id' => 'asc'); // default order
