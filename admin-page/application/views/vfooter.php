...
<script>
    $(document).ready(function() {
        ...
        $('#province').change(function() {
            var province = $('#province').val(); //ambil value id dari provinsi

            if (province != '') {
                $.ajax({
                    url: '<?= base_url(); ?>Kategori_produk/get_towns',
                    method: 'POST',
                    data: {
                        province: province
                    },
...
//             var id=$(this).val();
//             $.ajax({
//                 url : "<?php echo base_url();?>Kategori_produk/get_towns",
//                 method : "POST",
...
//                         html += '<option>'+data[i].nama_kota_kabupaten+'</option>';
//                     }
//                     $('#towns').html(html);
