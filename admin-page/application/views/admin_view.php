							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<?php 
								    if ($this->session->userdata('current_language')=='english'){
							 			$row2 = '<img src="'.base_url().'uploads/menu/english.png" style="height: 30px; width: 30px;">';
							 		}else{
							 			$row2 = '<img src="'.base_url().'uploads/menu/bahasa.png" style="height: 30px; width: 30px;">';
							 		}		

								   $bahasa = $this->session->userdata('current_language');
