...
<div class="tabbable">
	...
	<!-- <form class="form-horizontal" role="form" action="<?= site_url('About/upload')?>" method="POST" enctype="multipart/form-data"> -->
		<input type="hidden" name="id_about"/> 
		<div class="form-body">
			<div class="form-group" >
...
<script>
	...
	function update() {
			...
			$.ajax({
				...
				var img = '<?= base_url(); ?>../uploads/about/'+result.about_logo;
