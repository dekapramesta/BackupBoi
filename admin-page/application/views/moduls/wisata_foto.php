...
<div class="widget-box">
<div class="widget-header">
		<h4 class="widget-title">Form Foto</h4>
...
<form id="form-add" class="form-horizontal" action="<?= site_url('Berfoto/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data">
<!-- <form class="form-horizontal" action="<?= site_url('Berfoto/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data"> -->
...
<div class="widget-box">
<div class="widget-header">
		<h4 class="widget-title">Form Update Foto</h4>
...
<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('Berfoto/upload')?>" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	var save_method;
	var table;
	var link = "<?php echo site_url('Berfoto')?>";
	var kdFoto = "<?php echo @$key2;?>";
	...
	function edit(id) {
			...
			$.ajax({
				...
				var img = '<?= base_url(); ?>../uploads/foto_wisata/'+result.url_file_foto;
				$('[name="foto_id"]').val(result.foto_id);
	...
	function hapus(id) {
		if (confirm('Are you sure delete this data?')) {
			$.ajax ({
				url : "<?php echo site_url('Berfoto/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
