                    ...
                    $data =  @$data . "
										<div class='post'>
                                            ...
                                            <input type='hidden' name=" . $this->security->get_csrf_token_name() . " value=" . $this->security->get_csrf_hash() . ">
                                                ...
                                                <input type='hidden' name='id_artikel' id='id_artikel' value=" . $u->berita_id . ">
                                            </form>
											<a class='klik-id'>" . $row5 . "</a>
											</div>
