			...
			<div class="row">
				<?php 
						if ($this->session->userdata('current_language')=='english'){
								foreach ($event_thn_en as $u2){
									if($u2['event_foto']==''){ $cover = 'no_image.jpg'; }else{ $cover = $u2['event_foto']; }
								...
								foreach ($event_thn as $u){
									if($u['event_foto']==''){ $cover = 'no_image.jpg'; }else{ $cover = $u['event_foto']; }
									$row5 = '<img src="'.base_url().'uploads/event/'.$cover.'">';
