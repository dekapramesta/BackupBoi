...
<section class="awe-parallax page-heading-demo" style="background-position: 50% 12px;">
    ...
    <div class="container">
        <div class="blog-heading-content text-uppercase">
            <h2><?php echo get_phrase('Artikel') . " - " . $namatag; ?></h2>
        </div>
    </div>
</section>
                ...
                <div class="page-sidebar">
                    <div class="widget widget_search">
                        ...
                        <form onsubmit="search_artikel(this);" method="POST">
                            ...
                            <input type="search" name="cari_artikel" id="cari_artikel" value="<?php echo get_phrase('Masukkan Kata'); ?>">
                        </form>
                    </div>
                    ...
                    <div class="widget widget_categories">
                        ...
                        <ul class="css-treeview">
                            <?php foreach ($tahun as $thn) : ?>
                                <?php $bulantags = date('F', mktime(0, 0, 0, $thn['bulan'], 10)); ?>
                                ...
                                <li>
                                    ...
                                    <ul class="css-treeview">
                                        ...
                                        <li>
                                            ...
                                            <label><a href="<?php echo base_url('Artikel/' . $thn['thn'] . '/' . $bulantags) ?>"><?php echo $thn['bln'] ?></a></label>
